...
const Preview = ({data} : DataProps) => {
  ...
  return (
    <>
      <a data-aos="fade-up" target="_blank" rel="noreferrer" href={data.url} className="transition ease-in-out hover:scale-75 max-w-[256px] shadow-lg shadow-gray-800/50 hover:scale-105 transition duration-300 ease-in-out">
