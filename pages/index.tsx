        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-32 pb-16">
            <div className="fixed inset-0 overflow-hidden" aria-hidden="true">
                ...
                <div className="absolute top-0 left-0 w-full h-full">
                    <div className="absolute inset-0 bg-gradient-to-b to-transparent from-teal-500/10 via-teal-400/5" style={{ filter: "blur(80px)" }}></div>
                    <div className="absolute inset-0 bg-gradient-to-b to-transparent from-blue-400/10 via-blue-300/5" style={{ filter: "blur(80px)" }}></div>
                    <div className="absolute inset-0 bg-gradient-to-b to-transparent from-yellow-300/5 via-yellow-200/2" style={{ filter: "blur(80px)" }}></div>
                    <div
                ...
                <section className="flex flex-col items-center text-center px-4">
                    <div className="mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                        <div className="font-semibold flex items-center gap-2 rounded-full border border-teal-800/60 bg-teal-950/30 px-4 py-2 text-sm text-teal-300 shadow-lg backdrop-blur-md transition-all duration-300 hover:border-teal-700/80 hover:bg-teal-950/50">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-package-search h-4 w-4 text-teal-400"><path d="M21 10V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l2-1.14"/><path d="m15 22 2-2 4 4"/><path d="m17 20 4 4"/><path d="M12 22v-8"/><path d="M3.5 5.5 12 10l8.5-4.5"/><path d="M12 10v12"/></svg>
                            <span className="text-teal-400">Over 200+ free tools listed! </span>
                        </div>
                    </div>
                    <h1 className="text-5xl md:text-6xl font-extrabold leading-tight tracking-tight text-white mb-6 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                        <button className="gap-2 whitespace-nowrap shadow group inline-flex h-12 items-center justify-center rounded-lg bg-white px-8 text-base font-medium text-zinc-900 transition-all hover:bg-white/90 hover:shadow-xl ring-1 ring-zinc-300/50 hover:-translate-y-1 duration-300" type="button">
                            <span className="relative z-10 flex items-center">Explore All Tools<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-arrow-right ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform duration-300"><path d="M5 12h14"></path><path d="m12 5 7 7-7 7"></path></svg></span>
                        </button>
                    </div>
                    <div className="flex flex-col items-center lg:items-start gap-4 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 text-sm font-medium text-zinc-400">
                            <span className="flex items-center gap-1 hover:text-zinc-200 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-code h-6 w-6 text-orange-400"><polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline></svg>
                                Productivity
                            </span>
                            <span className="flex items-center gap-1 hover:text-zinc-200 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-smartphone h-6 w-6 text-emerald-400"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"></rect><line x1="12" x2="12" y1="18" y2="18"></line></svg>
                                Design
                            </span>
                            <span className="flex items-center gap-1 hover:text-zinc-200 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-brain h-6 w-6 text-sky-400"><path d="M12 5a3 3 0 1 0 0 6 3 3 0 1 0 0-6"/><path d="M12 18a3 3 0 1 0 0-6 3 3 0 1 0 0 6"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z"/></svg>
                                Desktop Apps
                            </span>
                            <span className="flex items-center gap-1 hover:text-zinc-200 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-bar-chart-2 h-6 w-6 text-rose-400"><line x1="18" x2="18" y1="20" y2="10"></line><line x1="12" x2="12" y1="20" y2="4"></line><line x1="6" x2="6" y1="20" y2="14"></line></svg>
                                Image and Video Editors
                            </span>
                            <span className="flex items-center gap-1 hover:text-zinc-200 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-figma h-6 w-6 text-fuchsia-400"><path d="M5.5 8.5A2.5 2.5 0 0 1 8 6h.5A2.5 2.5 0 0 1 11 8.5v.5H5.5z"/><path d="M5.5 15.5A2.5 2.5 0 0 0 8 18h.5A2.5 2.5 0 0 0 11 15.5v-.5H5.5z"/><path d="M18.5 8.5A2.5 2.5 0 0 0 16 6h-.5A2.5 2.5 0 0 0 13 8.5v.5h5.5z"/><path d="M18.5 15.5A2.5 2.5 0 0 1 16 18h-.5A2.5 2.5 0 0 1 13 15.5v-.5h5.5z"/><path d="M12 12h-1v-3.5A2.5 2.5 0 0 0 8.5 6H8A2.5 2.5 0 0 0 5.5 8.5v7A2.5 2.5 0 0 0 8 18h.5A2.5 2.5 0 0 0 11 15.5V12h1z"/></svg>
